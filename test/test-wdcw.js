...
describe('podcast-connector:setup', function describesConnectorSetup() {
  var setUpComplete;
...
describe('podcast-connector:columnHeaders', function describesConnectorColumnHeaders() {
  var registerHeaders;
...
describe('podcast-connector:tableData', function describesConnectorTableData() {
  var registerData;
...
describe('podcast-connector:teardown', function describesConnectorTearDown() {
